...
| 2026-08-14 | `HvA_full_dmn_export.dmn` deploys but can't be evaluated — Operaton's FEEL engine can't parse this DMN's multi-word bare-name convention, plus a rule-cell cross-decision-reference naming collision and three broken/placeholder expressions. Root causes, empirical evidence, and the fix (`HvA_full_dmn_export-patched.dmn`) documented in [`hva-full-dmn-export-feel-evaluation-fix.md`](hva-full-dmn-export-feel-evaluation-fix.md) — no change to this doc's own content or worked examples                                                                                                                                                                                                                                                                                            |
